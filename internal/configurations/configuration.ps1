...
Set-PSFConfig -Module dbachecks -Name policy.hadr.automatedbackuppreference -Value "Secondary" -Initialize -Description "Availability Group Automated Backup Preference for the HADR replica check"
